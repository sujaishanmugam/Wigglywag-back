...
import { getDoctorAppointments, makeReport } from "../../../actions/appointmentActions";
...
const server_url = process.env.NODE_ENV === 'production' ? 'https://exoclinic.herokuapp.com/' : "http://localhost:5000"
...
class Video extends Component {
	...
	closeReports=()=>this.setState({reportsModal:false,documentsModal:false})
...
componentDidUpdate(){
	...
	render() {
		...
		const documentsModalEl=(
			<>{this.state&&
				<Modal show={this.state.documentsModal} onHide={this.closeReports} style={{ zIndex: "999999" }}>
			...
			const reportsModalEl=(
				<>{this.state&&
					<Modal show={this.state.reportsModal} onHide={this.closeReports} style={{ zIndex: "999999" }}>
											<Modal.Header closeButton>
					...
					<div>
						...
						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								borderStyle: "solid",borderColor: "#bdbdbd",objectFit: "fill",width: "50%",height: "10%"}}></video>
						</div>
					</div>
					:
					<div>
						...
						<div className="video-container">
							<div style={{ paddingTop: "20px" }}>
								...
								{this.userType==="doctor"&&<><Button style={{backgroundColor: "#3f51b5",color: "whitesmoke",marginLeft: "20px",
									marginTop: "10px",width: "120px",fontSize: "10px"
								}} onClick={()=>this.setState({documentsModal:!this.state.documentsModal})}>view patient documents</Button>
							<Button style={{backgroundColor: "#3f51b5",color: "whitesmoke",marginLeft: "20px",
									marginTop: "10px",width: "120px",fontSize: "10px"
...
export default connect(mapStateToProps,{makeReport,getUsers,getDoctorAppointments})(Video);